...
import com.pedpo.pedporent.databinding.AdapterAlbumStoreBinding
...
@ActivityScoped
class AlbumStoreAdapter : RecyclerView.Adapter<AlbumStoreAdapter.ViewHolder> {
...
//    lateinit var binding: AdapterAlbumBinding;
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = AdapterAlbumStoreBinding.inflate(LayoutInflater.from(parent.context), parent, false)
...
//        Picasso.get().load(list?.get(position)?.image!!).into(binding.imgAlbum)
    ...
    class ViewHolder(private val binding: AdapterAlbumStoreBinding?) : RecyclerView.ViewHolder(binding?.root!!) {
