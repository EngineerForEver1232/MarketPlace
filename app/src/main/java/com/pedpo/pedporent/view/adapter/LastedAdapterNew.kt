...
@ActivityScoped
class LastedAdapterNew : RecyclerView.Adapter<LastedAdapterNew.ViewHolder> {
    ...
    inner class ViewHolder(val binding: AdapterRecomendedBinding) : RecyclerView.ViewHolder(binding.root) {
        fun initView(visitMarketTO: VisitMarketTO?){
            ...
            Log.i("adapterLasted", "initView: ${visitMarketTO?.free}")
            Log.i("adapterLasted", "initView: ${visitMarketTO?.rentPriceDay}")
        }
