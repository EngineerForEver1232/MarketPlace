package com.pedpo.pedporent.view.paging.search.adapter
...
class SearchMarketPagingAdapter(private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == TYPE_PROGRESS) {
            ...
            return SearchViewHolder(paginBinding)
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is SearchViewHolder){
            (holder as SearchViewHolder).bindView(getItem(position)!!)
        }else{
    ...
    inner class SearchViewHolder(val binding: AdapterPaginBinding) :
