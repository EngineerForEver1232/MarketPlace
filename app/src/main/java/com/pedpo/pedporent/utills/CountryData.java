...
public class CountryData {
    ...
    private static CountryData countryData = new CountryData();

    public static CountryData newInstance() {
        return countryData;
    }

    public final int[] countrayFlag = {
//            R.drawable.flag_usa,
            R.drawable.flag_usa,
            R.drawable.flag_iran
    };

    public final String[] countryAreaCodes =
            {
                    "+1",
                    "+98"
            };
    ...
    public int index(String str) {
        ...
        for (int i = 0; i < countryAreaCodes.length; i++) {
            if (countryAreaCodes[i].equals(str)) {
                number = i;
                break;
            }
        }
