...
object ContextApp {
        ...
        //calendar
        const val MILADI = "miladi"
        const val SHAMSI = "shamsi"

        // emoji
        const val EMOJI_ANGRY = "\uD83D\uDE28 "

        //image
        const val BASE_64 ="base64"
//        const val BASE_64_EditStore ="Base64"
        const val URL ="url"
        const val URI ="uri"
        ...
        const val CITY = "city"
        const val CITY_ID = "idCity"

        //Menu items
        const val DEACTIVE="Deactive";
        const val ACTIVE="active";
        const val IS_CLOSE_COMMENT="isCloseComment";
        ...
        const val PRICE_HOUR = "priceHour";
        const val PRICE_MONTH = "priceMonth";
        const val PRICE_YEAR = "priceYear";
        const val REAL_VALUE = "realValue";
        const val VALUE = "value";
        const val METRAZH_HOME = "MetrazhHome";
        const val ROOM = "Room";
        const val BAD_ROOM = "BadRoom";
        const val YEAR_CONNSTRUCTION = "YearConstruction";

        const val KM = "km";
        const val TYPE_FUEL = "TypeFuel";
        const val YEAR_CONNSTRUCTION_CAR = "YearConstructionCar";
        ...
        //heating type
        const val NATURAL_GAS = 1;
        const val FORCED_AIR = 2 ;
        const val NONE_HEATING=3;
        //coolding type
        const val CENTRAL_AIR_CONDITION = 1;
        const val ROOM_AIR_CONDITIONERS = 2;
        const val EVAPORATIVE_COOLERS =3;
        const val DUCTLESS_MIN_AIR_CONDITIONS=4;
        const val NONE_Coolding = 5;
        //parking
        const val CONCRETE=1;
        const val CARPORT=2;
        const val OPENDRIVEWAY=3;
        const val HEATED_GARAGE=4;
        const val UNDERGROUND=5;
        const val BOATHOUSE = 6;
        const val ATTACHED_PARKING=7;
        const val DETACHED_PARKING=8;
        const val NONE_PARKING=9;

        const val COUNT_LINE=6;
        const val COUNT_LINE_STORE=2;



        const val TYPE_MARKET = "Rent";
        const val RENT = "Rent";
        const val SALE = "Sale";
        const val SERVICE = "Service";
        const val SERVICE_CHILD_CATEGORY = "ServiceChildCategory";

        const val Car = "car";
        const val PAGE = "page";
        const val PHOTOS = "photos";
        const val PAGE_FILTER = "page_filter";
        const val TYPE_API = "typeAPI";
        const val LIKE = "like";
        const val DETAILS = "details";
        const val MENU = "menu";
        const val BOOKMARK = "bookmark";
        const val COUNT_IMAGE = "countImage";
        const val MULTI = "multi";
        const val SINGLE = "single";
        const val PERMISSION_PHOTO = "permissionPhoto";
        const val LINK = "link";
        const val COUNT = "count";
        const val TYPE = "type";
        const val TYPE_CATEGORY = "type";
        const val IS_HOME = "isHome";
        const val IS_CAR = "isCar";
        ...
        const val Pedpo = "Pedpo";
        const val SETTING_GALLERY = "settingGallery";
        const val CAMERA = "camera";
        const val IMAGE_LOGO = "logo";
        const val IMAGE_MADRAK = "madrak";
        const val GALLERY = "gallery";
        const val LOCATION = "location";
        const val RESULT = "result";
        const val LISEENING = "Liseening";
        const val LATITUDE = "latitude"
        const val LONGITUDE = "longitude"
        const val SHOULD_SHOW_RequestPermissionRationale = "shouldShow"
        ...
        const val BRANCHE_ID = "branchID"
        const val LOGO = "logo"
        const val EDIT_STORE = "editStore"
        const val MAIL = "mail"
        const val IS_USER = "isUser"
        const val URI_IMAGE = "image_uri"
        const val FINISH = 21;
        const val YEAR_HOME = 22;
        const val YEAR_CAR = 23;

        const val RESULT_Ad = 101;
