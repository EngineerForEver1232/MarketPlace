...
public class JalaliCalendar {
     ...
     * @return day name
     */
    public String getDayOfWeekStringEN() {
        switch (getDayOfWeek()) {
            case 1:
                return "Sun";
            case 2 :
    ...
    public String getMonthStringEN() {
        switch (getMonth()) {
            case 1:
                return "Farvardin";
            case 2 :
    ...
    public String getDayOfWeekDayMonthString() {
        return getDayOfWeekString() + " " + NumberFormatPersian.getNewInstance().toPersianNumbersSample(getDay()+"") + " " + getMonthString() ;
    }
    public String getDayOfWeekDayMonthStringEN() {
        return getDayOfWeekStringEN() + " " + NumberFormatPersian.getNewInstance().toNumberEnlish(getDay()+"") + " " + getMonthStringEN() ;
    }
