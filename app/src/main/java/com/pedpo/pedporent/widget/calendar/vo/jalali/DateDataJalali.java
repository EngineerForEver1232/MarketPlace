...
public class DateDataJalali {
    ...
    public DateDataJalali(int year, int month, int day){
        this.day = day;
        this.month = month;
        this.year = year;
        this.hour = 0;
    ...
    public DateDataJalali(int year, int month) {
        this.year = year;
        this.month = month;
        this.hour = 0;
        this.minute = 0;
    ...
    public DateDataJalali setYear(int year) {
        this.year = year;
        return this;
    }
    ...
    public DateDataJalali setMonth(int month) {
        this.month = month;
        return this;
    }
    ...
    public boolean equals(Object o) {
        DateDataJalali data = (DateDataJalali) o;
    ...
    public DateDataJalali setMarkStyle(MarkStyle markStyle) {
        this.markStyle = markStyle;
        return this;
    }

    public DateDataJalali setMarkStyle( int color){
